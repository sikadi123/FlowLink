...
INSERT INTO `user` (`id`, `username`, `email`, `password_hash`, `display_name`, `bio`, `status`) VALUES
  (1001, 'wanghui', 'wanghui@flowlink.local', 'demo:flowlink123', '王辉', '负责微信风格 UI 和交互体验。', 2),
  (1002, 'guimingyang', 'guimingyang@flowlink.local', 'demo:flowlink123', '桂明洋', '关注 Netty 长连接、ACK 与消息路由。', 2),
  (1003, 'xuqiantao', 'xuqiantao@flowlink.local', 'demo:flowlink123', '徐乾涛', '负责实时状态管理和消息幂等。', 2),
  (1004, 'jiangxudong', 'jiangxudong@flowlink.local', 'demo:flowlink123', '姜旭东', '负责 JWT、Redis 网关和敏感词策略。', 2),
  (1005, 'wangzhenyue', 'wangzhenyue@flowlink.local', 'demo:flowlink123', '王振越', '负责 MySQL、MinIO 和数据映射。', 2),
  (1006, 'gongxingwang', 'gongxingwang@flowlink.local', 'demo:flowlink123', '龚兴旺', '负责用户、好友和群组业务闭环。', 2);
...
INSERT INTO `friend_request` (`sender_id`, `receiver_id`, `message`, `status`) VALUES
  (1005, 1001, '数据库这边我已经准备好表结构了，拉我进前端联调。', 0);
...
INSERT INTO `message` (`conversation_type`, `sender_id`, `receiver_id`, `group_id`, `content`, `message_type`) VALUES
  ...
  (1, 1002, 1001, NULL, '王辉，先把 demo 做到能演示实时聊天就很够用了。', 1),
